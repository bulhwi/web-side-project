...
### 원본 참고: [www.bdseoulbd.com](https://www.bdseoulbd.com) (서울비디치과)

**v1.0 (2025.09)** - 치과 → 한의원 전환 + Apple 디자인
**v2.0 (진행 중)** - Studio 템플릿 기반 리팩토링

자세한 내용: [`docs/PRD.md`](docs/PRD.md)
...
└── docs/                # 프로젝트 문서화
    ...
    ├── tech-spec.md                    # Tailwind Plus 리팩토링 기술 사양
    ├── github-issues.md                # GitHub 이슈 목록 (30개)
    ├── bdseoulbd-interaction-analysis.md  # BD치과 인터랙션 분석
