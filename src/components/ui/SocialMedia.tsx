  ...
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 3C6.477 3 2 6.477 2 10.75c0 2.77 1.87 5.19 4.63 6.55l-1.23 4.48c-.09.32.27.58.55.39l5.24-3.49c.27.02.54.03.81.03 5.523 0 10-3.477 10-7.75S17.523 3 12 3Z"
      />
    </svg>
  )
}

function NaverBlogIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      <path
        fillRule="evenodd"
...
export const socialMediaProfiles = [
  ...
  { title: 'KakaoTalk', href: '#', icon: KakaoIcon },
  { title: 'Naver Blog', href: '#', icon: NaverBlogIcon },
]
